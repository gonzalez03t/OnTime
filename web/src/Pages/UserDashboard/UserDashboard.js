    ...
    return (
        <Container style={{ marginTop: 100 }} fluid>
            ...
            <Grid.Column width={11}>
                <ApptCalendar />
                <Button onClick={handleNewAppointment} icon basic size='big' color='black' style={{ marginTop: 10 }} floated='right'>
                    <Icon name='calendar plus' />
                </Button>
            </Grid.Column>
            <Grid.Column width={5}>
                <Segment fluid>
                    <Header as="h3" textAlign='center'>Scheduled Reminders</Header>
                </Segment>
            </Grid.Column>
            </Grid>
        </Container>
